...
public class GuiLineList extends GuiThemedScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawPanel();
        drawTitle(I18n.format(Names.Config.LANG_PREFIX + "." + this.alignment.toString().toLowerCase()));

        int textRight = this.rows.isEmpty() ? this.panelX + this.panelWidth - 10
                : this.rows.get(0).btnUp.x - ROW_BUTTON_GAP;
        int maxTextWidth = textRight - (this.panelX + 10);
